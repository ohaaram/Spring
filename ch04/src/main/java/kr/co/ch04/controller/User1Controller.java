...
public class User1Controller {
    ...
    @GetMapping("/user1/register")//view을 띄워주는것
    public String register(){
        return "/user1/register";
    }

    @PostMapping("/user1/register")//데이터를 넘겨줌
    ...
    public String list(Model model){
         ...
         //Model 참조(view에서 데이터 출력 setAttribute("users",user)와 똑같음)
    ...
    public String modify(@ModelAttribute User1DTO user1DTO){//@ModelAttribute은 생략가능하다
        System.out.println(user1DTO);
