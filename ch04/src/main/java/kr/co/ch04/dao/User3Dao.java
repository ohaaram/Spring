...
public class User3Dao {
    ...
    public void insertUser3(User3DTO user3DTO) {
        ...
        Object[] params = {user3DTO.getUid(), user3DTO.getName(), user3DTO.getBirth(), user3DTO.getHp(), user3DTO.getAddr()};
    ...
    public void updateUser3(User3DTO user3DTO){
        ...
        Object[] params = {user3DTO.getName(),user3DTO.getBirth(),user3DTO.getHp(),user3DTO.getAddr(),user3DTO.getUid()};
