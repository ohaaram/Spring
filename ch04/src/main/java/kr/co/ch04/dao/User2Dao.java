...
public class User2Dao {
    ...
    public void insertUser2(User2DTO user2DTO){
        ...
        Object[] params = {user2DTO.getUid(),user2DTO.getName(),user2DTO.getBirth(),user2DTO.getAddr()};
    ...
    public void updateUser2(User2DTO user2DTO){
        ...
        Object[] params = {user2DTO.getName(),user2DTO.getBirth(),user2DTO.getAddr(),user2DTO.getUid()};
